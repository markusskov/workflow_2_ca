...
"use strict";
var _objectHelpers = require("./scripts/objectHelpers");
var _query = require("./scripts/query");
const newProduct = (0, _objectHelpers.createProduct)(12, 'd f g', 'This is the title of the product, it will be truncated');
console.log(newProduct); // Api Call
(0, _query.getCharacters)();

},{"./scripts/objectHelpers":"eeLa9","./scripts/query":"b3auU"}],"eeLa9":[function(require,module,exports) {
"use strict";
...
function createProduct(id, code, title) {
    return {
        id: id,
        code: (0, _stringHelpers.makeUppercase)(code),
        title: (0, _stringHelpers.limitLength)(12, (0, _stringHelpers.replaceSpaces)(title))
    };
}

},{"./stringHelpers":"bufRI"}],"bufRI":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"b3auU":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
async function getCharacters() {
    ...
    let descSort = _.orderBy(result, [
        'name'
    ], [
        'desc'
    ]);
    console.log(descSort);
    for(let i = 0; i < descSort.length; i++)container.innerHTML += `
    <li class="cards">
...
},{}]},["8wcER","h7u1C"], "h7u1C", "parcelRequire716c")
